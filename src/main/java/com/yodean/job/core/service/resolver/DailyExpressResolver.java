 ...
 * 按天执行
 */
public class DailyExpressResolver extends AbstractExpressResolver {
    private static final Logger logger = LoggerFactory.getLogger(DailyExpressResolver.class);

    private Date startDate;

    public DailyExpressResolver(JobExpress jobExpress) {
        super(jobExpress);
    }
    ...
    public ScheduleBuilder getScheduleBuilder() {
        ...
        ScheduleBuilder scheduleBuilder = CalendarIntervalScheduleBuilder.calendarIntervalSchedule()
                                            .withIntervalInDays(jobExpress.getInterval());
